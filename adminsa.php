...
<head>
    ...
    font-size: 14px;
       ...
       grid-template-columns: 1fr 1fr 1fr;
        ...
        .form-grop.full { grid-column: 1 / -1; }
        .form-group label {
            font-size: 12px;
            font-wight: 700;
            color: 
        ...
        .form-group select,
        .form-group textare {
            padding: 10px 14          border: 2px solid #eee;
            border-radius: 8px;
            font-size: 14px;
           outline: none;
     ...
     transition: background 0.2s;
        ...
        .bt-primary:hover { background: #a93226; }
        .btn-secondary {
            background: #eee;
            olor: #555;
            b none;
...
<div class="container">
    ...
    <div class="table-card">
        ...
        <div class="total-registros"
            Total de registros: <strong><?= $herramientas->num_rows === 0 ? $conn->qu
